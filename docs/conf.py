...
extlinks = {
    "issue": ("https://github.com/fmaussion/salem/issues/%s", "GH%s"),
...
project = "salem"
copyright = "2015-2024, salem Developers"
...
man_pages = [(master_doc, "salem", "salem Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "salem",
        "Geoscientific data analysis and map projections.",
        "Miscellaneous",
    ),
]
